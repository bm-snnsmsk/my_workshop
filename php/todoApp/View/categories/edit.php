                ...
                <div class="card-body">
                 ...
                 // test($data) ;
                  ...
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control" name="title" id="title" value="<?= $data['categoriesTitle'] ;  ?>" >
                    <input type="hidden" class="form-control" name="categoriesId" id="categoriesId" value="<?= $data['categoriesID'] ;  ?>" >
                  </div>
                </div>
                <!-- /.card-body -->
