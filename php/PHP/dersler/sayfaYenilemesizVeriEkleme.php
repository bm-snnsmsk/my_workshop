...
<div class="container-fluid">
  ...
  <div class="mb-3 row">
        ...
        <button type="submit" class="btn btn-primary" id="mysubmit" onclick="fill('formID','fillForm')">Kaydet <span class="myload"></span>
        </button>
        </div> 
  </div>
...
function fill(formID, process){
    ...
    $.ajax({
        ...
        success:function(resultData){          
            ...
            resultData = resultData.split(':::',3) ;
            let tableShow = resultData[0] ; 
            let message = resultData[1] ; 
            let mistake = resultData[2] ;
            if(mistake == 'warning'){
               //alert("warning") ;
