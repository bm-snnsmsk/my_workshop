...
if($_POST){
    ...
    if(!$name || !$phone || !$address || !$payment){
        ...
        ## tüm müşterilere ait siparişler
        ...
        if($result->rowCount()){
            ...
            #### mesaj gönderme START
            #### smtp kütüphaneleri inc klasörü altındaki 
            #### class.phpmailer.php ve class.smtp.php
            ...
            $mail->SMTPAuth   = true;
            $mail->IsSMTP();
            $mail->AddAddress($arow->smtpkime); #### mesaj yöneticiye gidecek
            ...
            ## sipariş verildikten sonra sepetteki ürün silinir ama böylesi durumlar için silinme değil de durum 0 yapılsa sipariş güvenliği açısından daha doğru olacaktır 
