...
#### admin paneli sürekli buna benzer isteklerle yönetildiği için process.php?process=contentedit&id=1213 şu fonsiyon yazılmıştır
...
function IP(){
 ...
 ## admin panelinde kullanılan li veya a etiketlerine verilen class'lar dikkate alınarak bu fonksiyon düzenleneli
