<?php require_once 'inc/header.php';?>
    ...
    <main class="app-content">
      ...
      <div class="row">
       ...
       <!--  #### wordpress mantığnda üst köşede ekran tercilri diye bir seçenek var, ilgili ekranda kaç tane gösterilmeini istiyorsunuz diye kullanıcıdan bir talep ister -->
        ...
        <div class="col-md-12">
          ...
          <?php   
            ...
            if($s > ceil($total / $lim)){#### ceil($total / $lim) = toplam sayfa sayısı
              $s = 1; #### bu kod bloğu s sayfa sayısından fazla olduğundan yani en son sayfa ileri butonuna basıldığında kişiyi sayfa başına getirsin diye
            }
          ...
          <div>
            <ul class="pagination">
              <?php 
                if($total > $lim){
                  if($blim){ #### ?????? her türlü pagination çalışıyor
