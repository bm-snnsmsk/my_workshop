...
<!-- admin panelinde SEO ile ilgili işlemelere gerek yok  --> 
    <meta charset="utf-8">
    ...
    <!-- bu kod ile ckeditore bağlandıktan sonra yapılacak tek şey var -->
    <!-- Kullanılacak alanda <textarea class='ckeditor'></textarea>   etiketi yazmak yeterlidir -->
    <!-- veya farklı kullanımı yani özelleştirilebilir kullanımı için https://cdn.ckeditor.com/ sayfasına göz at -->
    <!-- CKEditor  END-->
