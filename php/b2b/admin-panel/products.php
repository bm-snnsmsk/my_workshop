              ...
              <table class="table table-hover">
                ...
                <tbody>
                  ...
                  <?php foreach($query as $row){ ?>
                    ...
                    <td><img src="<?php echo $site."/uploads/product/".$row['urunkapak'];?>" width="100" height="100"/></td> <!-- class.upload.php 2716 satırındaki getsize() fonksiyonun içeriği başltılınca hata vermeden çalıştı -->
