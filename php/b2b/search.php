...
<?php 
	...
	$where 		= null;
	$execute	= []; ## execute() ile göndermek için array
	...
	if($where != null){
		$sql .= ' WHERE ' . $where;
		$sql  = rtrim($sql, ' AND ');  ## en sondan AND 'i  sil
	}
		...
		<div class="tab-content">
			<div class="tab-pane active" id="grid-view">							
				<div class="row">
					...
					if(@$bgift > 0){  #### bayi indirimi varsa eğer ama bu indirim olayı sepetteyken de yapılabilir

						$calc  = $row['urunfiyat'] * $bgift / 100;
						$price = $row['urunfiyat'] - $calc;

					}else{
						$price = $row['urunfiyat'];  #### eğer bayi indirimi yoksa normal ürün fiyatı
					}
