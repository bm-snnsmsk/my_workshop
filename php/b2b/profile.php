...
//             $foo = new Upload($_FILES['logoimage']); 
// if ($foo->uploaded) {
//    // save uploaded image with no changes
//    $foo->process('uploads/customer');
//    if ($foo->processed) {
...
// } 
            ...
            // class.upload.php'de, 2714. satırındaki getsize() fonksiyonun içi boşaltıldıktan sonra çalıştı
    ...
    case 'newnotification':
        ...
        <div class="customer-login text-left">
            ...
            <select name="hbank" class="form-control">
            ...
            <input class="form-control" type="date" placeholder="Havale tarihi" name="hdate">
            <input class="form-control" type="text" placeholder="Havale saati" name="hhour">
            <input class="form-control" type="text" placeholder="Havale tutarı" name="hprice">
            <textarea class="form-control" name="hdesc" rows="10" placeholder="Havale açıklaması"></textarea>
...
case 'orderdetail':
    ...
    ## siparişteki tek tek ürünlerin listesi
